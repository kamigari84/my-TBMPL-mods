...
static class CustomizableInstantiator {
  ...
  static class PrefabInstantiatePatch {
    public static readonly HashSet<string> PatchedCache = new HashSet<string>();
    public static readonly Dictionary<string, Action<GameObject>> Patchers = new Dictionary<string, Action<GameObject>>();
